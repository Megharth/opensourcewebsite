export default {
  ...
  template: `
  <div>
    <div class="display-1 my-3">Terms of Service</div>
    <v-card class="px-4 py-3 subheading">
      <p>OpenSourceWebSite ("OSW") provide this web site (the "Website") as a public service to our users.</p>
      <p>Please read these Terms carefully before using this Website. By using this Website, you has accepted these Terms of Service ("TOS"). If you do not accept these TOS, do not use the Website.</p>
      <p>OSW may update the TOS at any time and without prior notice. Your continued use of this Website after changes to the TOS have been published constitutes your binding acceptance of the updated TOS. If at any time the TOS are no longer acceptable to you, you should immediately cease all use of this Website.</p>
      <div class="headline py-2">Statement of Purpose</div>
      <p>The purpose of OpenSourceWebsite is to show where open source principles are changing our world today, and to create an open dialog around where these principles are headed in the future. The site is designed to share information, ideas, and news relating to open source and the open source way. It is also designed to encourage the creation of a user community through contributions to written content and reader comments. Our hope is that the site is accessible and welcoming in order to broaden the audience for both understanding and applying the open source way.</p>
      <div class="headline py-2">Description of Service</div>
      <p>OSW provides you with access variety of services. ("OSW Service"). Unless explicitly stated otherwise, any new features that augment or enhance the current OSW Service shall be subject to the TOS.</p>
      <div class="headline py-2">Conduct</div>
      <p>You understand that all information, data, text, software, graphics or other materials ("Content"), whether publicly posted or privately transmitted, are the sole responsibility of the person from whom such Content originated. This means that you, and not OSW, are entirely responsible for all Content that you upload, post, email, transmit or otherwise make available via the OSW Service. OSW does not control the Content posted via the OSW Service and, as such, does not guarantee the accuracy, integrity or quality of such Content. Under no circumstances will OSW be liable in any way for any Content, including, but not limited to, any errors or omissions in any Content, or any loss or damage of any kind incurred as a result of the use of any Content posted, emailed, transmitted or otherwise made available via the OSW Service.</p>
      <p>You agree to not use the OSW Service to:</p>
      <ul>
      ...
      <p>To the extent any jurisdiction does not allow the exclusion or limitation of direct, incidental or consequetial damages, portions of the above limitation or exclusion may not apply.</p>
      <div class="headline py-2">Limitation of Liability</div>
      <p>You expressly understand and agree that OSW and its subsidiaries, affiliates, officers, employees, agents, partners and licensors shall not be liable to you for any direct, indirect, incidental, special, consequential or exemplary damages, including, but not limited to, damages for loss of profits, goodwill, use, data or other intangible losses (even if OSW has been advised of the possibility of such damages), resulting from the use or the inability to use the OSW service.</p>
      <div class="headline py-2">Privacy Policy</div>
      <p>Registration Data and certain other information about you is subject to our Privacy Policy.</p>
      <div class="headline py-2">Waiver and Severability</div>
      <p>OSW's failure to exercise or enforce any right or provision of these TOS shall not constitute a waiver of such right or provision. If one or more of the provisions contained in this Agreement is held invalid, illegal or unenforceable in any respect by any court of competent jurisdiction, such holding will not impair the validity, legality, or enforceability of the remaining provisions.</p>
      <div class="headline py-2">No Third Party Beneficiary</div>
      <p>These TOS do not confer any third-party beneficiary rights.</p>
      <div class="headline py-2">Entire Agreement</div>
      <p>These TOS supersede all previous agreements, understandings, and arrangements between the parties, whether oral or written, and constitutes the entire agreement between the parties regarding the subject matter herein.</p>
      <div class="headline py-2">Language</div>
      <p>These TOS are in the English language only, which language shall be controlling in all respects, and all versions of this Agreement in any other language shall be for accommodation only and shall not be binding.</p>
      <div class="headline py-2">Notification Of Possible Copyright Infringement</div>
      <p>In the event you believe that material or content published on the Website may infringe on your copyright or that of another, please mail to <a href="mailto:hello@opensourcewebsite.org">hello@opensourcewebsite.org</a>.</p>
    </v-card>
  </div>
  `
}